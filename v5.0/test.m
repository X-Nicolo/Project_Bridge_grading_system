...
% Last Modified by GUIDE v2.5 11-Mar-2017 10:27:32
...
all=A*0.4+B*0.4+C*0.2;
set(handles.zongtidefen,'string',all)
...
switch get(handles.popupmenu1,'Value')
    ...
    case 2%上部结构  
        ...
        global A;
        A=A1*0.7+A2*0.18+A3*0.12;
        set(handles.buweidefen,'string',A)
    case 3%下部结构
        global B1;
        global B2;
        global B3;
        ...
        global B7;
        global B;
        B=B1*0.3+B2*0.3+B3*0.28+B4*0.02+B5*0.01+B6*0.07+B7*0.02;
        set(handles.buweidefen,'string',B)
    case 4%桥面系
        global C1;
        global C2;
        global C3;
        ...
        global C6;
        global C;
        C=C1*0.4+C2*0.25+C3*0.1+C4*0.1+C5*0.1+C6*0.05;
        set(handles.buweidefen,'string',C)      
end
